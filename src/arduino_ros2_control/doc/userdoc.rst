...
1. To check that *DiffBot* description is working properly use following launch commands
   ...
   .. code-block:: shell
    ...
    ros2 launch arduino_ros2_control view_robot.launch.py
...
2. To start *DiffBot* example open a terminal, source your ROS2-workspace and execute its launch file with
   ...
   .. code-block:: shell
    ...
    ros2 launch arduino_ros2_control diffbot.launch.py
...
5. If everything is fine, now you can send a command to *Diff Drive Controller* using ROS 2 CLI interface:
   ...
   .. code-block:: shell
    ...
    [ArduinoHardware]: Got command 43.33333 for 'left_wheel_joint'!
    [ArduinoHardware]: Got command 50.00000 for 'right_wheel_joint'!
...
#########################
  ...
  - Hardware interface plugin: `bot_syst.cpp <https://github.com/ros-controls/ros2_control_demos/tree/master/example_2/hardware/bot_syst.cpp>`__
